...
typedef struct {
  nuttx_Bus_aa_tito_prueba In1;        // '<S7>/In1'
} B_pubsub_multitask_T;

// Block states (default storage) for system '<Root>'
typedef struct {
  nuttx_internal_block_Subscriber_pubsub_multitask_T obj;// '<S4>/SourceBlock'
  nuttx_internal_block_Publisher_pubsub_multitask_T obj_e;// '<S3>/SinkBlock'
  nuttx_internal_block_Publisher_pubsub_multitask_T obj_g;// '<S2>/SinkBlock'
  real_T lastSin;                      // '<Root>/Sine Wave'
  real_T lastCos;                      // '<Root>/Sine Wave'
  int32_T systemEnable;                // '<Root>/Sine Wave'
  uint8_T is_active_c3_pubsub_multitask;// '<Root>/Chart'
  uint8_T is_c3_pubsub_multitask;      // '<Root>/Chart'
...
extern const nuttx_Bus_aa_tito_prueba2
  pubsub_multitask_rtZnuttx_Bus_aa_tito_prueba2;// nuttx_Bus_aa_tito_prueba2 ground 
...
//  '<S1>'   : 'pubsub_multitask/Chart'
//  '<S2>'   : 'pubsub_multitask/uORB Publish'
//  '<S3>'   : 'pubsub_multitask/uORB Publish1'
//  '<S4>'   : 'pubsub_multitask/uORB Subscribe'
//  '<S5>'   : 'pubsub_multitask/uORB Topic'
//  '<S6>'   : 'pubsub_multitask/uORB Topic1'
//  '<S7>'   : 'pubsub_multitask/uORB Subscribe/Enabled Subsystem'
